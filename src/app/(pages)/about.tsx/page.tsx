    ...
    <main className="default-layout">
      ...
      <section className="px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[420px_1fr] lg:items-center">
          ...
          <div className="mx-auto">
            <div className="bg-secondary default-shadow overflow-hidden rounded-4xl border border-zinc-800/50">
          ...
          <div className="space-y-8">
            <div className="space-y-5">
              ...
              <p className="text text-lg leading-relaxed">Sou apaixonado por tecnologia e pela construção de aplicações que resolvem problemas reais. Atualmente trabalho principalmente com React, Next.js, Node.js, TypeScript e bancos de dados SQL.</p>
      ...
      <section className="px-4 py-24 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="space-y-8">
            <TimelineItem year="2023" title="Primeiros passos" description="Início dos estudos em lógica de programação e JavaScript." />
